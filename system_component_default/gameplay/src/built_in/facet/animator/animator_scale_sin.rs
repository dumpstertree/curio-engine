...
impl FieldOverride for AnimatorScaleSin {
...
impl Default for AnimatorScaleSin {
    fn default() -> Self {
        Self {
            owner: None,
            enabled: false,
...
impl FacetCommon for AnimatorScaleSin {
...
unsafe impl Send for AnimatorScaleSin {}
unsafe impl Sync for AnimatorScaleSin {}
