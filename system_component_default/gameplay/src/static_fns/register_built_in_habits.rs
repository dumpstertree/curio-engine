use crate::{
    built_in::habit::{
        system_debug_gui_screen, system_debug_gui_time, system_debug_toggle,
        system_renderer_update_light_state::{self},
        update_animator_position_sin, update_animator_rotation_sin, update_animator_scale_sin, update_transform,
    },
...
pub fn register_built_in_ecs() {
    ...
    register_global_ecs::<update_transform::Instance>();
