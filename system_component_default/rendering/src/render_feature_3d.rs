use curio_core::{Vector2, built_in::record::sys_record_camera::SysRecordCamera, collections::game_state::GameState, graphics::graphics_mapping::GraphicsMapping, io::texture_asset::TextureAsset, system_adapters::adapter_system_gpu::SystemGPU};
