...
// const FOG_WGSL_PATH: &str = "../postprocess_outline.wgsl";

pub struct RenderFeaturePostProcessOutline {
...
impl RenderFeaturePostProcessOutline {
    pub fn new(
        ...
        let shader = device.create_shader_module(wgpu::ShaderModuleDescriptor {
            ...
            source: wgpu::ShaderSource::Wgsl(Cow::Borrowed(include_str!("../postprocess_outline.wgsl"))),
        });
...
impl RenderFeaturePostProcess for RenderFeaturePostProcessOutline {
    fn render(&mut self, encoder: &mut wgpu::CommandEncoder, _input_view: &wgpu::TextureView, output_view: &wgpu::TextureView, postprocess_source: PostProcessSource) {
        ...
        let mut pass = encoder.begin_render_pass(&wgpu::RenderPassDescriptor {
            ...
            color_attachments: &[Some(wgpu::RenderPassColorAttachment {
                ...
                resolve_target: None,
                ops: wgpu::Operations {
                    load: wgpu::LoadOp::Clear(egui_wgpu::wgpu::Color { r: 0.0, g: 0.0, b: 0.0, a: 0.0 }),
