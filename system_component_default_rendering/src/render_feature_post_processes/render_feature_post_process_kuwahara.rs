...
pub struct RenderFeaturePostProcessKuwahara {
    pipeline: egui_wgpu::wgpu::RenderPipeline,
    bind_group: egui_wgpu::wgpu::BindGroup,
}

impl RenderFeaturePostProcessKuwahara {
    pub fn new(device: Arc<egui_wgpu::wgpu::Device>, input_view: &egui_wgpu::wgpu::TextureView, sampler: &egui_wgpu::wgpu::Sampler, depth_view: &egui_wgpu::wgpu::TextureView) -> Box<RenderFeaturePostProcessKuwahara> {
        let shader = device.create_shader_module(egui_wgpu::wgpu::ShaderModuleDescriptor {
            label: Some("Kuwahara Shader"),
            source: egui_wgpu::wgpu::ShaderSource::Wgsl(include_str!("../postprocess_kuwahara.wgsl").into()),
        });
...
impl RenderFeaturePostProcess for RenderFeaturePostProcessKuwahara {
