...
//         true
//     }
//     fn will_tick(&mut self, state: &mut GameState, world: &mut WorldContext, _: &mut EventQueue) {
//         //
//         let state = state.get::<StateCollision>();
...
//         });
//     }
//     fn debug(&mut self, state: &mut GameState, world: &mut WorldContext, _: &mut EventQueue) {
