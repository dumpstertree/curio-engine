...
use crate::{
    ...
    io::asset_loader::{AssetLoader, ASSET_UID_SHADER_UNLIT, ASSET_UID_TEXTURE_FONT_ATLAS},
    AssetCommon, Material, Matrix4x4, Mesh, ModelAsset, ShaderDesc, TextureAsset, Vertex,
};
