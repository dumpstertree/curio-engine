use crate::{NetworkModes, StateOwnerships, StateSyncEvent};

#[derive(Clone)]
pub struct StateNetworkCapabilities {
...
impl StateNetworkCapabilities {}
impl StateNetworkCapabilities {
    pub fn new(privilige: NetworkModes) -> StateNetworkCapabilities {
        StateNetworkCapabilities { privilege: privilige, ouput_sync_events: Vec::new() }
    }
}
