use crate::{
    built_in::tween_transform3d_scale::TweenTransform3DScale,
    data::{curve::TweenCurve, tween_state::TweenState},
};
use curio_core::Vector3;

pub struct TweenTransform3DScaleBuilder {
...
impl TweenTransform3DScaleBuilder {
    ...
    pub fn build(self) -> TweenTransform3DScale {
        TweenTransform3DScale {
