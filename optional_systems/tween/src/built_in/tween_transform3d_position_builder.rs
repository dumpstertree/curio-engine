use crate::{
    built_in::tween_transform3d_position::TweenTransform3DPosition,
    data::{curve::TweenCurve, tween_state::TweenState},
};
use curio_core::Vector3;

pub struct TweenTransform3DPositionBuilder {
...
impl TweenTransform3DPositionBuilder {
    ...
    pub fn build(self) -> TweenTransform3DPosition {
        TweenTransform3DPosition {
